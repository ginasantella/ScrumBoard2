        ...
        this.pblRef.on("value", (snapshot) => {
            ...
            snapshot.forEach((child) => {
              // console.log("****"+child.val().description);
               ...
               if(this.state.description!=""&&child.val().description == this.state.description && once!=true){
                    console.log("********SUCCESS LOOP*********");
                    var correctProjKey =  this.state.projectKey;
                   pbiDescript=this.state.description;
                   pbiAcc=this.state.ac;
                   pbiUserStory=this.state.userStory;
                    done=true;
                    once=true;
